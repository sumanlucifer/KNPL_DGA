sap.ui.define(
    ...
    function (
        ...
        return BaseController.extend(
            "com.knpl.dga.feedbackform.controller.Worklist", {
            formatter: formatter,
            /* =========================================================== */
            /* lifecycle methods                                           */
            /* =========================================================== */
            ...
            onInit: function () {
                ...
                this.getView().setModel(oModel, "oDynamicModel");
                var startupParams;
            ...
            onCmpTypChange: function (oEvent) {
                ...
                if (sId === "RB") {
                    sap.ui.getCore().byId("RadioButton").setVisible(true);
                    sap.ui.getCore().byId("CheckBox").setVisible(false);
                } else if (sId === "CB") {
                    sap.ui.getCore().byId("CheckBox").setVisible(true);
                    sap.ui.getCore().byId("RadioButton").setVisible(false);
                }
            },
            ...
            onCloseAddQuestions: function (oEvent) {
                this.oQRCodeDialog.close();
            },
            onAddForm: function () {
                if (!this.oFormDialog) {
                    Fragment.load({ type: "XML", controller: this, name: "com.knpl.dga.feedbackform.view.fragments.CreateForm" }).then(function (oDialog) {
            ...
            onPress: function () {
                var oModel = this.getView().getModel("oDynamicModel");
                ...
                var that = this;
                var oPanel = sap.ui.getCore().byId("contactInformationEmPanel");
                var oRadioBtnTemplate = new sap.ui.core.CustomData({
                    key: "{RadioBtn}",
                    value: "{RadioBtn}"
                });
                ...
                oRadioBtn.setModel(oModel); // set model to Select element
                oRadioBtn.bindAggregation("customData", "/RadioBtn", oRadioBtnTemplate);
                var oInputTemplate = new sap.ui.core.Item({
                    value: "{Input}"
                });
                var oInput = new sap.m.Input();
                oInput.setModel(oModel); // set model to Select element
                oInput.bindAggregation("suggestionItems", "/Input", oInputTemplate);
                ...
                var oGridLayout = new sap.ui.layout.Grid({
                    content: [oRadioBtn, oInput, delIcon]
                });
