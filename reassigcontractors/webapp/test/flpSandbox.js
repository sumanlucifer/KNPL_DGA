		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ui5 Template",
									"targetURL": "#comknpldgareassigcontractors-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldgareassigcontractors-display": {
								"semanticObject": "comknpldgareassigcontractors",
								"action": "display",
								...
								"resolutionResult": {
									...
									"url": sap.ui.require.toUrl(" com/knpl/dga/reassigcontractors")
								}
							}
						}
					}
