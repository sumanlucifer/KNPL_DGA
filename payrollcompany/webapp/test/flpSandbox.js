		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ui5 Template",
									"targetURL": "#comknpldgapayrollcompany-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldgapayrollcompany-display": {
								"semanticObject": "comknpldgapayrollcompany",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.dga.payrollcompany",
									"url": sap.ui.require.toUrl("com/knpl/dga/payrollcompany")
								}
							}
						}
					}
