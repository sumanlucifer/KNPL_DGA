sap.ui.define([
    ...
    return Controller.extend("com.knpl.dga.payrollcompany.controller.BaseController", {
        /**
         ...
         * 1. com.knpl.dga.payrollcompany
         * 2. com/knpl/dga/payrollcompany - used in test folder for flp config
         * 3. com-knpl-dga-payrollcompany - used in the manifest
         * 4  comknpldgapayrollcompany - used in test folder for flp config
         */
        getRouter: function () {
        ...
        _AddObjectControlModel: function (mParam1, mParam2) {
            ...
            var oDataControl = {
                ...
                resourcePath: "com.knpl.dga.payrollcompany",
                AddFields: {
                    PainterMobile: "",
                    PainterName: "",
                    PainterMembershipId: "",
