		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DGA",
									"targetURL": "#comknpldgadgamanage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldgadgamanage-display": {
								"semanticObject": "comknpldgadgamanage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.dga.dgamanage",
									"url": sap.ui.require.toUrl("com/knpl/dga/dgamanage")
								}
							}
						}
					}
