		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ui5 Template",
									"targetURL": "#comknpldgaproductrecommendation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldgaproductrecommendation-display": {
								"semanticObject": "comknpldgaproductrecommendation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.dga.productrecommendation",
									"url": sap.ui.require.toUrl("com/knpl/dga/productrecommendation")
								}
							}
						}
					}
