sap.ui.define([
    ...
    "use strict";
    return BaseController.extend("com.knpl.dga.productrecommendation.controller.Worklist", {
        formatter: formatter,
        /* =========================================================== */
        /* lifecycle methods                                           */
        /* =========================================================== */
        ...
        getFilters: function (aCurrentFilterValues) {
            var aFilters = [];
            var aKeys = [
                "search", "CreatedAt", "ProductRecommendationName", "CreatedByDetails"
            ];
        ...
        handleSortButtonPressed: function () {
            this.getViewSettingsDialog("com.knpl.dga.productrecommendation.view.fragments.SortDialog")
                .then(function (oViewSettingsDialog) {
                    oViewSettingsDialog.open();
                });
        },
        handleFilterButtonPressed: function () {
            this.getViewSettingsDialog("com.knpl.dga.productrecommendation.view.fragments.FilterDialog")
                .then(function (oViewSettingsDialog) {
                    oViewSettingsDialog.open();
                });
        },
