		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ui5 Template",
									"targetURL": "#comknpldgaperformancetarget-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldgaperformancetarget-display": {
								"semanticObject": "comknpldgaperformancetarget",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.dga.performancetarget",
									"url": sap.ui.require.toUrl("com/knpl/dga/performancetarget")
								}
							}
						}
					}
