		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Complains",
									"targetURL": "#comknpldgacomplains-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldgacomplains-display": {
								"semanticObject": "comknpldgacomplains",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.dga.complains",
									"url": sap.ui.require.toUrl("com/knpl/dga/complains")
								}
							}
						}
					}
