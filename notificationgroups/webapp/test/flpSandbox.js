		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ui5 Template",
									"targetURL": "#comknpldganotificationgroups-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldganotificationgroups-display": {
								"semanticObject": "comknpldganotificationgroups",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.dga.notificationgroups",
									"url": sap.ui.require.toUrl("com/knpl/dga/notificationgroups")
								}
							}
						}
					}
