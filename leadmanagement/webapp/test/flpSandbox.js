		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comknpldgaleadmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldgaleadmanagement-display": {
								"semanticObject": "comknpldgaleadmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.dga.leadmanagement",
									"url": sap.ui.require.toUrl("com/knpl/dga/leadmanagement")
								}
							}
						}
					}
