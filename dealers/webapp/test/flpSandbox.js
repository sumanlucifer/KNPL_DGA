		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ui5 Template",
									"targetURL": "#comknpldgadealers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldgadealers-display": {
								"semanticObject": "comknpldgadealers",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.dga.dealers",
									"url": sap.ui.require.toUrl("com/knpl/dga/dealers")
								}
							}
						}
					}
