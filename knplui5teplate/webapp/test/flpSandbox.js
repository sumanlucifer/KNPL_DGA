		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comknpldgauitemplateknplui5teplate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldgauitemplateknplui5teplate-display": {
								"semanticObject": "comknpldgauitemplateknplui5teplate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.dga.uitemplate.knplui5teplate",
									"url": sap.ui.require.toUrl("com/knpl/dga/uitemplate/knplui5teplate")
								}
							}
						}
					}
