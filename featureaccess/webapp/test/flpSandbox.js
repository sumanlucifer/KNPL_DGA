		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ui5 Template",
									"targetURL": "#comknpldgafeatureaccess-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldgafeatureaccess-display": {
								"semanticObject": "comknpldgafeatureaccess",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.dga.featureaccess",
									"url": sap.ui.require.toUrl("com/knpl/dga/featureaccess")
								}
							}
						}
					}
