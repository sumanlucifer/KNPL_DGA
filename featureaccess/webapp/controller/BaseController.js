sap.ui.define([
    ...
    return Controller.extend("com.knpl.dga.featureaccess.controller.BaseController", {
        /**
         ...
         * 1. com.knpl.dga.featureaccess
         * 2. com/knpl/dga/featureaccess - used in test folder for flp config
         * 3. com-knpl-dga-featureaccess - used in the manifest
         * 4  comknpldgafeatureaccess - used in test folder for flp config
         */
        getRouter: function () {
        ...
        _AddObjectControlModel: function (mParam1, mParam2) {
            ...
            var oDataControl = {
                ...
                resourcePath: "com.knpl.dga.featureaccess",
                AddFields:{
                    PainterMobile:"",
                    PainterName:"",
                    PainterMembershipId:"",
