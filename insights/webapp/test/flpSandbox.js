		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Insights",
									"targetURL": "#comknpldgainsights-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpldgainsights-display": {
								"semanticObject": "comknpldgainsights",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.dga.insights",
									"url": sap.ui.require.toUrl("com/knpl/dga/insights")
								}
							}
						}
					}
