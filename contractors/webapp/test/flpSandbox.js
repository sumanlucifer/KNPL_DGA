		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ui5 Template",
									"targetURL": "#comknplpragatiContactPainter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknplpragatiContactPainter-display": {
								"semanticObject": "comknplpragatiContactPainter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.pragati.ContactPainter",
									"url": sap.ui.require.toUrl("com/knpl/pragati/ContactPainter")
								}
							}
						}
					}
